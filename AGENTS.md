...
_(Merged and enhanced from v1.0 → v5.0. Works with any repo, language, framework, CI/CD system, and deployment target. Compatible with Claude Code, Gemini CLI, Cursor, Copilot Workspace, Codex CLI, Antigravity, or any AI coding agent.)_
...
- Rollback-first mentality: for every change you're about to make, know _how it would be undone_ before you make it.
