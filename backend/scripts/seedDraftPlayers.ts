...
const WC_PLAYERS: PlayerTemplate[] = [
  ...
  { name: 'Marcos Aoás Corrêa (Marquinhos)', club: 'Paris Saint-Germain', nationality: 'BR', position: 'DEF', basePrice: 48 },
  { name: 'Nicolas Otamendi', club: 'Benfica', nationality: 'AR', position: 'DEF', basePrice: 22 },
  { name: 'Nahuel Molina', club: 'Atlético Madrid', nationality: 'AR', position: 'DEF', basePrice: 28 },
  { name: 'Gonzalo Montiel', club: 'Sevilla', nationality: 'AR', position: 'DEF', basePrice: 24 },
  { name: 'Lisandro Martínez', club: 'Manchester United', nationality: 'AR', position: 'DEF', basePrice: 44 },
  { name: 'Cristian Romero', club: 'Tottenham', nationality: 'AR', position: 'DEF', basePrice: 34 },
  { name: 'Germán Pezzella', club: 'River Plate', nationality: 'AR', position: 'DEF', basePrice: 16 },
  { name: 'Nico Tagliafico', club: 'Lyon', nationality: 'AR', position: 'DEF', basePrice: 24 },
  { name: 'Jesús Navas', club: 'Sevilla', nationality: 'ES', position: 'DEF', basePrice: 18 },
  { name: 'Aymeric Laporte', club: 'Al Nassr', nationality: 'ES', position: 'DEF', basePrice: 36 },
  { name: 'José María Giménez', club: 'Atlético Madrid', nationality: 'UY', position: 'DEF', basePrice: 34 },
  ...
  { name: 'Benjamin Mendy', club: 'Lorient', nationality: 'FR', position: 'DEF', basePrice: 16 },
  { name: 'Raphaël Varane', club: 'Como', nationality: 'FR', position: 'DEF', basePrice: 26 },
  { name: 'Jérôme Boateng', club: 'Lyon', nationality: 'DE', position: 'DEF', basePrice: 14 },
...
const UCL_PLAYERS: PlayerTemplate[] = [
  ...
  // ── Extra high-price DEFs for GOLD tier depth ──
  { name: 'Marcos Aoás Corrêa (Marquinhos)', club: 'Paris Saint-Germain', nationality: 'BR', position: 'DEF', basePrice: 50 },
  { name: 'Lisandro Martínez', club: 'Manchester United', nationality: 'AR', position: 'DEF', basePrice: 46 },
  { name: 'Aymeric Laporte', club: 'Al Nassr', nationality: 'ES', position: 'DEF', basePrice: 38 },
  { name: 'José María Giménez', club: 'Atlético Madrid', nationality: 'UY', position: 'DEF', basePrice: 36 },
  ...
  { name: 'Raphaël Varane', club: 'Como', nationality: 'FR', position: 'DEF', basePrice: 28 },
  { name: 'Sergio Ramos', club: 'Sevilla', nationality: 'ES', position: 'DEF', basePrice: 26 },
  { name: 'Jordi Alba', club: 'Inter Miami', nationality: 'ES', position: 'DEF', basePrice: 24 },
  { name: 'Mats Hummels', club: 'Roma', nationality: 'DE', position: 'DEF', basePrice: 22 },
  // ── Extra DEFs for Draft Mode pool depth ──
