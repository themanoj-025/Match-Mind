...
const WC_PLAYERS: PlayerTemplate[] = [
  // ── GK (24) ──
  { name: 'Alisson Becker', club: 'Liverpool', nationality: 'BR', position: 'GK', basePrice: 50 },
  { name: 'Thibaut Courtois', club: 'Real Madrid', nationality: 'BE', position: 'GK', basePrice: 55 },
  { name: 'Ederson', club: 'Manchester City', nationality: 'BR', position: 'GK', basePrice: 48 },
  { name: 'Mike Maignan', club: 'AC Milan', nationality: 'FR', position: 'GK', basePrice: 45 },
  { name: 'Marc-André ter Stegen', club: 'Barcelona', nationality: 'DE', position: 'GK', basePrice: 44 },
  { name: 'Gianluigi Donnarumma', club: 'Paris Saint-Germain', nationality: 'IT', position: 'GK', basePrice: 46 },
  { name: 'David Raya', club: 'Arsenal', nationality: 'ES', position: 'GK', basePrice: 38 },
  { name: 'Emiliano Martínez', club: 'Aston Villa', nationality: 'AR', position: 'GK', basePrice: 42 },
  { name: 'Jan Oblak', club: 'Atlético Madrid', nationality: 'SI', position: 'GK', basePrice: 40 },
  { name: 'Manuel Neuer', club: 'Bayern Munich', nationality: 'DE', position: 'GK', basePrice: 41 },
  { name: 'Gregor Kobel', club: 'Borussia Dortmund', nationality: 'CH', position: 'GK', basePrice: 35 },
  { name: 'André Onana', club: 'Manchester United', nationality: 'CM', position: 'GK', basePrice: 32 },
  { name: 'Diogo Costa', club: 'FC Porto', nationality: 'PT', position: 'GK', basePrice: 36 },
  { name: 'Unai Simón', club: 'Athletic Bilbao', nationality: 'ES', position: 'GK', basePrice: 33 },
  ...
  { name: 'Lunin Andriy', club: 'Real Madrid', nationality: 'UA', position: 'GK', basePrice: 28 },
  { name: 'Alex Remiro', club: 'Real Sociedad', nationality: 'ES', position: 'GK', basePrice: 27 },
  { name: 'Giorgi Mamardashvili', club: 'Valencia', nationality: 'GE', position: 'GK', basePrice: 29 },
  { name: 'Robert Sánchez', club: 'Chelsea', nationality: 'ES', position: 'GK', basePrice: 25 },
  { name: 'Alphonse Areola', club: 'West Ham', nationality: 'FR', position: 'GK', basePrice: 22 },
  { name: 'Mark Flekken', club: 'Brentford', nationality: 'NL', position: 'GK', basePrice: 18 },
  { name: 'Koen Casteels', club: 'Al Qadsiah', nationality: 'BE', position: 'GK', basePrice: 15 },
  { name: 'Mathew Ryan', club: 'AZ Alkmaar', nationality: 'AU', position: 'GK', basePrice: 12 },
...
const UCL_PLAYERS: PlayerTemplate[] = [
  // ── GK (24) ──
  { name: 'Thibaut Courtois', club: 'Real Madrid', nationality: 'BE', position: 'GK', basePrice: 58 },
  { name: 'Alisson Becker', club: 'Liverpool', nationality: 'BR', position: 'GK', basePrice: 52 },
  { name: 'Ederson', club: 'Manchester City', nationality: 'BR', position: 'GK', basePrice: 50 },
  { name: 'Mike Maignan', club: 'AC Milan', nationality: 'FR', position: 'GK', basePrice: 48 },
  { name: 'Marc-André ter Stegen', club: 'Barcelona', nationality: 'DE', position: 'GK', basePrice: 46 },
  { name: 'Gianluigi Donnarumma', club: 'Paris Saint-Germain', nationality: 'IT', position: 'GK', basePrice: 48 },
  { name: 'David Raya', club: 'Arsenal', nationality: 'ES', position: 'GK', basePrice: 40 },
  { name: 'Jan Oblak', club: 'Atlético Madrid', nationality: 'SI', position: 'GK', basePrice: 42 },
  { name: 'Manuel Neuer', club: 'Bayern Munich', nationality: 'DE', position: 'GK', basePrice: 43 },
  { name: 'Gregor Kobel', club: 'Borussia Dortmund', nationality: 'CH', position: 'GK', basePrice: 38 },
  { name: 'André Onana', club: 'Manchester United', nationality: 'CM', position: 'GK', basePrice: 34 },
  { name: 'Diogo Costa', club: 'FC Porto', nationality: 'PT', position: 'GK', basePrice: 38 },
  { name: 'Unai Simón', club: 'Athletic Bilbao', nationality: 'ES', position: 'GK', basePrice: 35 },
  { name: 'Giorgi Mamardashvili', club: 'Valencia', nationality: 'GE', position: 'GK', basePrice: 32 },
  { name: 'Lukáš Hrádecký', club: 'Bayer Leverkusen', nationality: 'FI', position: 'GK', basePrice: 28 },
  { name: 'Yann Sommer', club: 'Inter Milan', nationality: 'CH', position: 'GK', basePrice: 30 },
  { name: 'Kepa Arrizabalaga', club: 'Bournemouth', nationality: 'ES', position: 'GK', basePrice: 26 },
  { name: 'Marco Sportiello', club: 'AC Milan', nationality: 'IT', position: 'GK', basePrice: 20 },
  ...
  { name: 'Mile Svilar', club: 'Roma', nationality: 'RS', position: 'GK', basePrice: 16 },
  ...
  { name: 'Alexander Nübel', club: 'Stuttgart', nationality: 'DE', position: 'GK', basePrice: 18 },
