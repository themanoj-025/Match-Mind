...
| ------- | --------------------------------------------------------------------- | ---------- | ----- | ------------------------- | ----------------------------------------------------------- |
| BLK-001 | pytest collects binary test-output*.txt as tests → UnicodeDecodeError | 2026-08-01 | Eng   | CI test collection errors | 🔴 Open — move .txt artifacts out of tests dir / add ignore |
