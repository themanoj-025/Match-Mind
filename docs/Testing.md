...
> Note: pytest collection currently fails on binary `test-output*.txt` files in backend/tests — see Tracker.md BLK-001 (use Vitest config excludes / move artifacts).
...
| ---------------------------------------------------- | ----------------- |
| [Rules.md](Rules.md)                                 | Test requirements |
