...
| R-009 Test artifact collection errors | High       | Low      | 3     | Move/ignore test-output files            | QA       | 🔴 Open (BLK-001) |
...
| [SecurityAndCompliance.md](SecurityAndCompliance.md) | R-004/005     |
| [TechSpec.md](TechSpec.md)                           | R-001/002/008 |
