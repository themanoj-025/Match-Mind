        ...
        <div className="container">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <Link
                to="/dashboard"
                className="flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-[#111111] hover:bg-neutral-100 px-3 py-2 sharp-corners transition-colors"
              >
            ...
            <div className="flex items-center gap-4">
              <form onSubmit={handleSearch} className="hidden md:flex items-center">
                <div className="relative group">
                  <Search
                    size={16}
                    strokeWidth={1.5}
                    className="absolute left-0 top-1/2 -translate-y-1/2 text-[#111111]"
                  />
                  <input
                    type="text"
                    value={searchQuery}
              ...
              <Link
                ...
                className="relative p-2 text-[#111111] border border-transparent hover:border-[#111111] sharp-corners transition-colors"
              >
              ...
              <Link
                to="/profile/me"
                className="flex items-center justify-center w-10 h-10 border border-[#111111] bg-white hover:bg-black hover:text-white sharp-corners transition-colors group"
              >
                {(user as { avatar?: string })?.avatar ? (
                  <img
                    src={(user as { avatar?: string }).avatar || ''}
                    alt=""
                    className="w-full h-full object-cover grayscale group-hover:sepia-[50%]"
                  />
                ) : (
