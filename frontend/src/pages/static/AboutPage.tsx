    ...
    <motion.div className="min-h-screen">
      ...
      <section className="py-20 sm:py-28" style={{ background: 'var(--gradient-hero)' }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="body-large text-[var(--mm-text-secondary)] max-w-2xl mx-auto">
            We're building the world's most exciting social sports prediction network. Watch live. Predict scores.
      ...
      <section className="py-16 sm:py-24 max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-4 body-large text-[var(--mm-text-secondary)]">
          <p>
            MatchMind was born in a sports bar in Manchester, where a group of friends argued endlessly about who truly
            knew sport best. The idea was simple: what if every match became a chance to prove it?
          </p>
          <p>
            From that spark, we built a platform where millions of fans watch live sports, predict outcomes, compete on
            leaderboards, and talk sport together in real-time.
          </p>
          <p>
            Today, MatchMind covers 6 sports across 47 countries, with thousands of predictions made every minute. And
      ...
      <section
        ref={valuesRef}
        className="py-16 sm:py-24 bg-[var(--mm-bg-secondary)] border-y border-[var(--border-subtle)]"
      >
        <div className="max-w-5xl mx-auto px-4">
          ...
          >
            {values.map((v, i) => (
              <motion.div
                ...
                className="value-card bg-[var(--mm-bg-primary)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)] p-6 text-center hover:border-[var(--border-active)] transition-all"
              >
        ...
        >
          {team.map((member, i) => (
            <motion.div
              key={i}
              variants={cardStaggerItem}
              className="bg-[var(--mm-bg-secondary)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)] p-6 text-center hover:border-[var(--border-active)] transition-all"
            >
      ...
      <section className="py-16 sm:py-24 bg-[var(--gradient-live)]">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <Link
            to="/signup"
            className="inline-flex items-center gap-2 bg-[var(--mm-text-inverse)] text-[var(--mm-accent-green)] body font-bold px-8 py-4 rounded-[var(--radius-md)] hover:shadow-[var(--shadow-elevated)] transition-all group"
          >
