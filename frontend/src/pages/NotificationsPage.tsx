...
const FALLBACK_NOTIFS = [
  {
    ...
    message: 'You earned +50 pts on Man City vs Arsenal',
    time: '2m ago',
    isRead: false,
  },
  { id: '2', type: 'rank', title: 'Rank changed', message: "You're now #198 globally", time: '15m ago', isRead: false },
  {
    ...
    message: 'Arsenal vs Chelsea kicks off in 30 min',
    time: '25m ago',
    isRead: false,
  },
  {
    ...
    type: 'social',
    title: 'New follower',
    message: 'SportsKing started following you',
    time: '1h ago',
    isRead: true,
  },
  {
    ...
    message: 'You unlocked 🔥 On Fire badge',
    time: '3h ago',
    isRead: true,
  },
  {
    ...
    type: 'league',
    title: 'League update',
    message: 'Premier Minds leaderboard updated',
    time: '5h ago',
    isRead: true,
  },
  {
...
export default function NotificationsPage() {
  ...
  const filteredItems =
    activeFilter === 'all'
      ? allNotifs
      : allNotifs.filter(
          (n) => n.type === activeFilter || (activeFilter === 'system' && ['system', 'achievement'].includes(n.type)),
        )
  ...
  return (
    <motion.div className="min-h-screen pt-16 pb-20 md:pb-8">
      <Helmet>
        <title>Notifications — MatchMind</title>
      </Helmet>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1 caption text-[var(--mm-accent-green)] font-medium hover:underline"
            >
