...
const achievements = [
  ...
  },
  {
    icon: '🌍',
    name: 'Global Fan',
    description: 'Predict matches from 3 different sports',
    rarity: 'common',
    unlocked: true,
    unlockedAt: 'Jan 2026',
  },
  ...
  },
  {
    icon: '⚡',
    name: 'Speed Guesser',
    description: 'Make 10 predictions within 5 minutes of kickoff',
    rarity: 'rare',
    unlocked: false,
    progress: '3/10',
  },
  ...
  },
  {
    icon: '🏟️',
    name: 'Match Hero',
    description: 'Get 20 predictions correct in a single day',
    rarity: 'rare',
    unlocked: false,
    progress: '2/20',
  },
  ...
  },
  {
    icon: '🎪',
    name: 'Variety King',
    description: 'Predict matches in all 6 sports',
    rarity: 'epic',
    unlocked: false,
    progress: '1/6',
  },
  {
    ...
    rarity: 'legendary',
    unlocked: false,
    progress: '3,500/10,000 pts',
  },
  {
    icon: '🚀',
    name: 'Rocket Start',
    description: 'Earn 500 points in your first week',
    rarity: 'rare',
    unlocked: true,
    unlockedAt: 'Jan 2026',
  },
...
export default function AchievementsPage() {
  ...
  return (
    <motion.div className="min-h-screen pt-16 pb-20 md:pb-8">
      <Helmet>
        <title>Achievements & Badges — MatchMind</title>
      </Helmet>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-[var(--mm-bg-secondary)] border border-[var(--border-subtle)] rounded-[var(--radius-xl)] p-5 mb-6">
          ...
          <div className="h-2 bg-[var(--mm-bg-tertiary)] rounded-full overflow-hidden">
            <div
              className="h-full bg-[var(--gradient-live)] rounded-full transition-all"
