...
export default function SignupPage() {
  ...
  return (
    <motion.div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[var(--mm-bg-secondary)] border border-[var(--border-subtle)] rounded-[var(--radius-xl)] p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <label className="caption font-medium text-[var(--mm-text-secondary)] mb-1.5 block">
                Confirm Password
              </label>
              <div className="relative">
                <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--mm-text-muted)]" />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[var(--mm-bg-secondary)] px-4 caption text-[var(--mm-text-muted)]">
                or continue with
              </span>
            </div>
          </div>
          ...
          <p className="text-center mt-6 body text-[var(--mm-text-secondary)]">
            ...
            <Link to="/login" className="text-[var(--mm-accent-green)] font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </div>
